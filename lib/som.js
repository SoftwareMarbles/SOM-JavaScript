...
var iterateImplementation = function(collection, iterator, execute) {
    ...
    var nextIteration = function() {
        if(currentIndex == collection.length) {
            ...
            ++currentIndex;
            //  Inform the callback function that the iteration has ended.
            execute(function() { iterator(nextIteration, undefined); });
        } if(currentIndex > collection.length) {
            ...
            execute(function() { iterator(nextIteration, collection[currentIndex++]); });
        }
    }
